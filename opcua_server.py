...
class OpcUaSimulator:
    ...
    def _run(self) -> None:
        ...
        try:
            ...
            node_defaults = {
                ...
                "CNC/CncOn": True,
                "CNC/NoAlarm": True,
                "CNC/LoaderEnable": True,
                "CNC/AirPressureOk": True,
                "CNC/MachinePositionOk": True,
                "CNC/Chuck1Open": False,
                "CNC/Chuck1Closed": True,
                "CNC/DoorClosedLocked": True,
                "CNC/M474Executed": False,
                "CNC/M475Executed": False,
    ...
    def _push_state(self) -> None:
        ...
        values = {
            ...
            "CNC/CncOn": state["cnc"]["cnc_on"],
            "CNC/NoAlarm": state["cnc"]["no_alarm"],
            "CNC/LoaderEnable": state["cnc"]["loader_enable"],
            "CNC/AirPressureOk": state["cnc"]["air_pressure_ok"],
            "CNC/MachinePositionOk": state["cnc"]["machine_position_ok"],
            "CNC/Chuck1Open": state["cnc"]["chuck1_open"],
            "CNC/Chuck1Closed": state["cnc"]["chuck1_closed"],
            "CNC/DoorClosedLocked": state["cnc"]["door_closed_locked"],
            "CNC/M474Executed": state["cnc"]["m474_executed"],
            "CNC/M475Executed": state["cnc"]["m475_executed"],
