...
typedef struct tagODBIFSBFSSBUNT {
    short   slv_unt_num;    /* X[ujbgԍ */
    short   fssb_unt_num;   /* FSSBjbgԍ */
    char    name[4];        /*  */
} ODBIFSBFSSBUNT;
...
typedef struct tagODBIFSBCOMSTATDTL {
    long    error_inf;      /* G[ */
    long    jitter_inf;     /* Wb^ */
    char    n_warning;      /* mCY[jOtO */
    char    j_warning;      /* Wb^[jOtO */
    char    reserve[2];     /* U[u */
} ODBIFSBCOMSTATDTL;

typedef struct tagODBIFSBWARNINGMSG {
    short   line;     /* [jOCԍ */
    short   slv_src;  /* [jOX[uԍ(ʐM) */
    short   slv_dst;  /* [jOX[uԍ(ʐM) */
    short   type;     /* [jO^Cv */
    char    wm_typ[32]; /* [jObZ[W(ܰݸގ) */
    char    wm_pnt[32]; /* [jObZ[W(ܰݸމӏ) */
} ODBIFSBWARNINGMSG;
...
typedef struct tagODBIFSBWARNHSTMSG {
    ...
    char    second;     /*                   b */
    char    dummy;
    ODBIFSBWARNINGMSG   msg_dat;    /*$ bZ[W $*/
} ODBIFSBWARNHSTMSG;
